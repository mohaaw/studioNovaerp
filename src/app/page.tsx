...
import { DollarSign, ListChecks, Package, Users } from "lucide-react"
  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <KpiCard title="Active Projects" value="12" icon={<Package className="h-4 w-4 text-muted-foreground" />} description="+2 since last week" />
        ...
        <KpiCard title="Team Members" value="21" icon={<Users className="h-4 w-4 text-muted-foreground" />} description="3 new members this quarter" />
      </div>
      ...
      <Card>
        ...
        <CardContent>
          <Table>
            ...
            <TableBody>
              <TableRow>
                <TableCell className="font-medium">New document 'Q3 Report' uploaded</TableCell>
              ...
              <TableRow>
                <TableCell className="font-medium">New team member 'Charlie Brown' added</TableCell>
